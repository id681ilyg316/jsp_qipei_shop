...
<HTML xmlns=""><HEAD><TITLE>汽车配件购物网站欢迎你</TITLE>
...
<script type='text/javascript' src='/qipei_shop/dwr/engine.js'></script>
<script type='text/javascript' src='/qipei_shop/dwr/util.js'> </script>
<script type='text/javascript' src='/qipei_shop/dwr/interface/Sysuser.js'> </script>
...
<BODY background="/qipei_shop/admin/images/bj.gif"><LINK href="shop/head.css" 
...
if(request.getAttribute("suc")!=null)
{
 ...
 alert("注册成功");
 parent.location.replace("/qipei_shop/index.jsp");
 </script>
 <%
 }
  %>
  <jsp:include page="top.jsp"></jsp:include>
<form action="/qipei_shop/servlet/Regeditmember" name="f1" >
...
<span id=ctname ></span></TD>
            ...
            var ajax = new AJAX();
            ajax.post("/qipei_shop/servlet/CheckUname?uname="+f1.uname.value);
            ...
            document.getElementById("cuname").innerHTML="";
                  ...
                  <script language="javascript" src="/qipei_shop/yyfiles/ajax.js"></script>
                </label></TD>
                </TR>
              </TBODY></TABLE></TD></TR>
        <TR>

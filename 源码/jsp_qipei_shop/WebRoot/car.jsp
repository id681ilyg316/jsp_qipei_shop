...
window.location.replace("/qipei_shop/");
</script>
                          ...
                          <TR>
                            <TD class=menutitle1>
                              ...
                              align=center border=0>
                                ...
                                <TBODY>
                                <TR>
                                <TD width="38%" rowspan="4" class=menutitle1><img src="/qipei_shop/upfile/<%=h.get("filename") %>" width="70" height="67" /></TD>
                                <TD width="62%" height="19" class=menutitle1><a class=orange 
                                href="/qipei_shop/xiang.jsp?id=<%=h.get("id") %>" >
                               ...
                               折扣:<%=!h.get("discount").equals("不打折")?h.get("discount")+" 折":"不打折" %>
                                ...
                                function fsdd()
                                {
                                  ...
                                  pop.setContent("contentUrl","/qipei_shop/fs.jsp?tgj=<%=ztotal%>&zhj=<%=ztotalz%>");

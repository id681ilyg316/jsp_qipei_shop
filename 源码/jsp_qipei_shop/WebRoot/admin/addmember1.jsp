...
if(suc!=null)
{
 ...
 <script language=javascript>
 alert("操作成功");
 parent.location.replace("/qipei_shop/admin/hygl.jsp");
 ...
 <%
  ...
  <form action="/qipei_shop/servlet/Addmember" name="f1" >
    ...
    style="padding: 0px;border-right-width: 0px;border-bottom-width: 0px;">
      <tr>
        <td>
            ...
            cellspacing="0"qipei_shopstyle="WIDTH: 100%; BORDER-COLLAPSE: collapse">
...
<script language="javascript" src="/qipei_shop/shop/popup.js"></script>
  <script language="javascript" src="/qipei_shop/shop/ajax.js"></script>

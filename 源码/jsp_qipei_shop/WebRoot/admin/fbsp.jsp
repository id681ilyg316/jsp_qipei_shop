...
<table width="95%" border="0" align="center"  cellpadding="0" cellspacing="0" >
  <tr>
    <td height="28" colspan="2" align="center"><strong>发布汽配</strong></td>
  </tr>
  <tr>
    <td width="221" height="34" align="center">汽配名称 </td>
...
<tr>
    <td width="221" height="34" align="center">汽配类别 </td>
...
if(pronameobj.value==""){  
document.getElementById("clabelproname").innerHTML="&nbsp;&nbsp;<font color=red>请输入汽配名称</font>";  
return false;  
}else{
...
if(protypeobj.value==""){  
document.getElementById("clabelprotype").innerHTML="&nbsp;&nbsp;<font color=red>请输入汽配类别</font>";  
return false;  
}else{

...
&nbsp;&nbsp;</td>
      ...
      <td bgcolor="#f3ffe3"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#c0de98">
          <tr align="center"> 
            <td width="" height="22" background="/qipei_shop/admin/images/tab_14.gif" class="STYLE1">汽配名称</td>
<td width="" height="22" background="/qipei_shop/admin/images/tab_14.gif" class="STYLE1">保质期</td>
<td width="" height="22" background="/qipei_shop/admin/images/tab_14.gif" class="STYLE1">产地</td>
<td width="" height="22" background="/qipei_shop/admin/images/tab_14.gif" class="STYLE1">汽配类别</td>
<td width="" height="22" background="/qipei_shop/admin/images/tab_14.gif" class="STYLE1">价格</td>
<td width="" height="22" background="/qipei_shop/admin/images/tab_14.gif" class="STYLE1">库存量</td>
<td width="" height="22" background="/qipei_shop/admin/images/tab_14.gif" class="STYLE1">折扣</td>
<td width="" height="22" background="/qipei_shop/admin/images/tab_14.gif" class="STYLE1">状态</td>
<td width="" height="22" background="/qipei_shop/admin/images/tab_14.gif" class="STYLE1">发布时间</td>
<td width="" height="22" background="/qipei_shop/admin/images/tab_14.gif" class="STYLE1">操作</td>
            </tr>
...
<script language=javascript src='/qipei_shop/js/ajax.js'></script>
<% 
...
<%=Info.tform(mmm)%> 
<script language=javascript src='/qipei_shop/js/My97DatePicker/WdatePicker.js'></script>
<script language=javascript src='/qipei_shop/js/popup.js'></script>
<script language=javascript> 
function update(no){ 

          ...
          <TD>
              ...
              <TR>
                <TD>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD width=529><span class="STYLE4" style="color:#CC6633">汽配详情</span></TD>
			...
			%>
				...
				<td width="76%">	  
                  ...
                  pop.setContent("contentUrl","/qipei_shop/num.jsp?id="+no);
                  pop.setContent("title","输入数量");
                  pop.build();
                  pop.show();
                 
							    
							   // fcar.action='/qipei_shop/servlet/Bookcar?bookid='+no; 
							  //  fcar.submit();
							  //  alert("已放入购物车");
							    }
                              </script>                              </td>
                              <td width="24%" rowspan="6" align="center"><img height=100 src="/qipei_shop/upfile/<%=h.get("filename") %>" align=left border=0></td>
                            </tr>    
             ...
             <tr>
               ...
               <tr>
                 ...
                 <c:if test="${ sessionScope.user ne null }">
                  <form action="/qipei_shop/qipei_shop?ac=addpinlun&proid=<%=id %>" method="post">
                ...
                {
                 %>  
                  评级 : <a href="/qipei_shop/qipei_shop?ac=pinj&proid=<%=id %>&pj=5">☆☆☆☆☆</a> &nbsp;&nbsp;&nbsp;
		                 <a href="/qipei_shop/qipei_shop?ac=pinj&proid=<%=id %>&pj=4"> ☆☆☆☆</a> &nbsp;&nbsp;&nbsp;
		                 <a href="/qipei_shop/qipei_shop?ac=pinj&proid=<%=id %>&pj=3"> ☆☆☆</a> &nbsp;&nbsp;&nbsp;
		                  <a href="/qipei_shop/qipei_shop?ac=pinj&proid=<%=id %>&pj=2">☆☆</a> &nbsp;&nbsp;&nbsp;
		                 <a href="/qipei_shop/qipei_shop?ac=pinj&proid=<%=id %>&pj=1"> ☆</a> &nbsp;&nbsp;&nbsp;
                  <%} %>
                  </form>
                  </c:if>

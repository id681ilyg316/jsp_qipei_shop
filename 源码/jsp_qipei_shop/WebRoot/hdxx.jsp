                ...
                <TD>
                  ...
                  border=0>
                    ...
                    <TR>
                      ...
                      <a href="/qipei_shop/"><span class="STYLE4" style=" color:#CC6633">最新汽配</span></a>
                      <%
                      ...
                      for(HashMap m:typelist){
                       %>
                      &nbsp;&nbsp;&nbsp;&nbsp; 
                      <a href="/qipei_shop/index.jsp?f=f&key=<%=m.get("typename") %>"><span class="STYLE4" style=" color:#CC6633"><%=m.get("typename") %></span></a>
                      <%} %>
                      
                       &nbsp;&nbsp;&nbsp;&nbsp; 
                      <a href="/qipei_shop/hdxx.jsp"><span class="STYLE4" style=" color:red">查看最新动态</span></a>
...
sql+="order by a.id desc ";
  ...
  int i=0;
PageManager pageManager = PageManager.getPage("/qipei_shop/hdxx.jsp?1=1",4, request);
					  ...
					  <table cellspacing=0 cellpadding=2 width="100%" border=0>
                          <tbody>
                            ...
                            <tr>
                              ...
                              <img height=80 width="90" src="/qipei_shop/upfile/<%=h.get("filename") %>" align=left border=0></td>
                              <td width="87%" align="left"><a href="/qipei_shop/hdxiang.jsp?id=<%=h.get("id")%>" >

...
<HTML xmlns=""><HEAD><TITLE>汽车配件购物网站</TITLE>
  ...
  <TR>
    ...
    <TD vAlign=top>
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <TR>
          <TD><LINK href="/qipei_shop/shop/globle.css" type=text/css 
            rel=stylesheet><LINK href="/qipei_shop/shop/head.css" type=text/css 
            rel=stylesheet><LINK href="/qipei_shop/shop/copyright.css" 
            type=text/css rel=stylesheet>
            <SCRIPT src="/qipei_shop/shop/engine.js" type=text/javascript></SCRIPT>

            <SCRIPT src="/qipei_shop/shop/util.js" type=text/javascript> </SCRIPT>

            <SCRIPT src="/qipei_shop/shop/pro.js" type=text/javascript> </SCRIPT>

            <SCRIPT src="/qipei_shop/shop/ejproselect.js" 
            type=text/javascript></SCRIPT>

            <SCRIPT src="/qipei_shop/shop/bwuhan.js" 
type=text/javascript> </SCRIPT>

            <TABLE cellSpacing=0 cellPadding=0 width="100%" 
            background=/qipei_shop/shop/02side(1).gif border=0>
              <TBODY>
              <TR>
                <TD height=27 colspan="2" background=/qipei_shop/shop/02top(1).gif>
...
共 <%=records %> 条记录
                                ...
                                <a href="/qipei_shop/message.jsp">首页</a>
                                
                                &nbsp;&nbsp;
                                
                                <a href="/qipei_shop/message.jsp?dpagee=<%=dpage-1 %>">上页</a>
                                
                                &nbsp;&nbsp;
                                
                                <a href="/qipei_shop/message.jsp?dpagee=<%=dpage+1 %>">下页</a>
                                
                                &nbsp;&nbsp;
                                
                                
                                <a href="/qipei_shop/message.jsp?dpagee=<%=pages %>">末页</a>
 ...
 <TR>
                           ...
                           <form action="/qipei_shop/servlet/Message" name=f1 >
                           <TABLE cellSpacing=0 cellPadding=7 width="100%"    border=0>
                           <TBODY>
                           <TR>
        ...
        <TR>
          <TD align="center"><LINK href="/qipei_shop/shop/globle.css" type=text/css 
            rel=stylesheet><LINK href="/qipei_shop/shop/head.css" type=text/css 
            rel=stylesheet><LINK href="/qipei_shop/shop/copyright.css" 
            type=text/css rel=stylesheet>
            <SCRIPT src="/qipei_shop/shop/engine.js" type=text/javascript></SCRIPT>
...
href="/qipei_shop/shop/head.css" type=text/css rel=stylesheet>

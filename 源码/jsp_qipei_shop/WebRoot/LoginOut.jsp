                ...
                <TD>
                  ...
                  border=0>
                    ...
                    <TR>
                      ...
                      <a href="/qipei_shop/"><span class="STYLE4" style=" color:#CC6633">全部汽配</span></a>
...
sql+="order by a.id desc ";
  ...
  int i=0;
PageManager pageManager = PageManager.getPage("/qipei_shop/index.jsp?1=1",12, request);
					  ...
					  <table cellspacing=0 cellpadding=2 width="229%" border=0>
                          <tbody>
                            ...
                            <tr>
                              ...
                              <img height=80 src="/qipei_shop/upfile/<%=h.get("filename") %>" width=92 align=left border=0></td>
                              <td width="82%" align="left"><a href="/qipei_shop/xiang.jsp?id=<%=h.get("id")%>" >

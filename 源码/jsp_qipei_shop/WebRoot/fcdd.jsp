                  ...
                  bgColor=#ffffff border=0>
                    ...
                    <TR>
                      <TD class=orangelight align=center width=500 
                        bgColor=#F6E1DE>汽配名称</TD>
                      <TD width="500" align=center 
                        bgColor=#F6E1DE class=orangelight><LABEL>汽配价格</LABEL></TD>
                      <TD width="500" align=center 
...
PageManager pageManager = PageManager.getPage("/qipei_shop/fcdd.jsp?1=1", 10, request);
                  ...
                  <TR>
                      ...
                      <TD width="500" align=center ><%=p.get("mprice") %>元 - <%=p.get("discount").equals("不打折")?"不打折":p.get("discount")+"折" %></TD>
                       ...
                       <TD width="500" align=center  ><img src="/qipei_shop/upfile/<%=p.get("filename") %>" height="60" /></TD>
